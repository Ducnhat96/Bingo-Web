...
const TotalRewardGame: React.FC<TotalRewardGameProps> = ({
  ...
  return (
    <div className="fixed bottom-10 mt-8 flex w-fit flex-col gap-2 rounded-2xl border-2 border-primary bg-white px-4 py-2">
      <p className="app-text-body-medium">Total rewards of this game is </p>
      <div className="flex w-full items-center justify-start gap-2">
        <span className="app-text-headline-medium text-primary">{amount}</span>
